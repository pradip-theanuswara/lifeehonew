...
<div class="region region-userprofile-onpagemenu">
  ...
  <div class="content">
    <ul class="nice-menu nice-menu-down" id="nice-menu-1"><li class="menu-2768 menuparent  menu-path-front  first   odd  home"><a>Connect</a><ul><li class="menu-2773 menu-path-community-dashboard  first   odd  "><a href="<?php echo base_path(); ?>community/dashboard" title="My Community">My Community</a></li>
<li class="menu-2774 menu-path-user-matches   even  "><a href="<?php echo base_path(); ?>userlist/matches" title="My Matches">My Matches</a></li>
...
//                                }
                            ...
                            <div id="calender">
                                <a href="<?php echo base_path(); ?>calender"><img alt="Calender" src="<?php echo base_path().drupal_get_path('theme','lifeecho'); ?>/images/calender.png" /></a>
                            </div>
                        </div>
                        <div class="imgtable">
