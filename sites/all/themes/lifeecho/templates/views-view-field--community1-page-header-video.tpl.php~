...
$youtube_video_url = file_create_url($row->field_field_video_file[0]['rendered']['#file']->uri);
$video_pieces = explode('=',$youtube_video_url);
$custom_thumbnail_image = file_create_url($row->field_field_video_youtube_thumbnail[0]['rendered']['#item']['uri']);
