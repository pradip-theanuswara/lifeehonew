...
<?php
if(function_exists('logged_user_has_community')) {
$community_count = 0;
$community_count = logged_user_has_community();
} ?>
</ul>
</div>
   <div class="second">     
...
<li class="menu-2770 menuparent  menu-path-front odd"><a title="Disciple"><?php print t('Disciple'); ?></a><ul><li class="menu-2780 menu-path-user  first   odd   last "><a href="<?php echo url('calendar'); ?>" title="Goes to main calendar"><?php print t('Goes to main calendar'); ?></a></li>
	...
	<?php print render($page['header']); ?>	
       ...
       <div class="third">
           <?php
           global $user;
           if((($user->uid != 0) && arg(2) != 'edit') && (arg(0) == 'user' && arg(2) == '')) { ?>
           <div class="imgdiv">
                        <div class="user">
                            <div id="imgdiv1">
                                <?php
echo "Anish ".$hascommunity_count;
if(arg(0) == 'user' || arg(0) == 'users') {

                                print l(t('USER DASHBOARD'),'user', array('attributes' => array('class' => 'dashboard-link'))).'</br>';

if($community_count > 0 || $community_count_admin > 0) { // check logged user has a community
...
<?php if($user->uid != 0 && (arg(2) != 'edit')) { ?><div class="messages-new"><?php } ?>        
      <?php if ($messages): ?>
  <?php print $messages; ?>
 <?php endif; ?>
<?php if($user->uid != 0 && (arg(2) != 'edit')) { ?></div><?php } ?>
 
<?php 
if(($user->uid == 0 && arg(0)== 'user') || (arg(0) == 'user' && arg(2) == 'edit') || (arg(0) == 'user' && arg(2) != '')) {
...
<?php print render($page['userprofilecontent']); ?>
                 ...
                 <div class="Userdashboard"><?php print render($page['userprofilecontent']); ?></div>
                    <div class="imgdivCOMMUNITY2">
                    <div class="imgdivCOMMUNITY-inner2">
               <?php print render($page['sidebar_ad1']); ?>
                    </div>
...
<!--<div class="imgdivCOMMUNITY-inner4"><?php print render($page['sidebar_ad5']); ?></div>-->
                 <?php /* <img width="192" height="430" src="<?php echo base_path().drupal_get_path('theme','lifeecho'); ?>/images/sponsored_ads.png" /> */ ?>                   
</div>
        <?php
    }
    ?>
