...
?>
	<div class="Userdashboard"><?php print render($page['content']); // display core blocks ?></div>
<?php }
else {?>
	<div class="Userdashboard dashboarditem" id="community_dashboard">
	<h2 class="dash_heading"><?php print t('ADMIN DASHBOARD'); ?></h2>	
	<?php print render($page['userprofilecontent']); ?></div>
