...
<?php
/* This file added to remove jquery conflict between the calendar and left sidebar contents */
...
?>
<li class="conflicted_items" ><a href="<?php echo url('node/'.$pieces[0]).'?sparam=1'; ?>" title="My Community"><?php 
           ...
           <div class="imgdiv">
                        <div class="user">
                            <div id="imgdiv1">
                                ...
                                if(arg(0) == 'user' || arg(0) == 'users' || arg(0) == 'calendar') {
...
echo '<a class="dashboard-link" href="'.url('community/dashboard').'" >'.t('ADMIN DASHBOARD').'</a>';
  ...
  <?php print $messages; ?>
  <?php endif; ?>
     <div class="mastercal_outer"> <?php print render($page['content']); // display core blocks ?></div>
