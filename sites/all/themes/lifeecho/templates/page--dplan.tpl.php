...
<li class="menu-2773 dplan-issue-item menu-path-community-dashboard  first odd"><a href="#" title="My Community"><?php print t('My Community'); ?></a></li>
...
echo '<a class="dashboard-link" href="'.url('community/dashboard').'" >'.t('ADMIN DASHBOARD').'</a>';
                            ...
                            <div id="calender">
                                <a href="<?php echo base_path(); ?>calendar"><img alt="Calender" src="<?php echo base_path().drupal_get_path('theme','lifeecho'); ?>/images/calender.png" /></a>
                            </div>
                        </div>
                        <div class="imgtable">
  ...
  <?php print $messages; ?>
  <?php endif; ?>
    <div class="Userdashboard span9">
    <?php print render($page['content']); // display core blocks ?></div>
