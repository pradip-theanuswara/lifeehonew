...
$community_count = get_logged_user_community_ID();
   ...
   <div class="second">                
		   ...
		   if($_GET['sparam']!='1')
{ ?>
			<?php if(arg(2) <> 'edit') { print render($page['userprofilemybio']); } ?>    
<div class="third">
...
echo '<a class="dashboard-link" href="'.url('community/dashboard').'" >'.t('ADMIN DASHBOARD').'</a>';
                            ...
                            <div id="calender">
                                <a href="<?php echo url('calendar'); ?>"><img alt="" src="<?php echo base_path().drupal_get_path('theme','lifeecho'); ?>/images/calender.png" /></a>
                            </div>
                        </div>
                        <div class="imgtable">
...
<div class="imgdiv" id="community_dasbboard">
                        <div class="user">
                            <div id="imgdiv1">
                                ...
                                if(arg(0) == 'user' || arg(0) == 'users' || $_GET['sparam']=='1') {
...
echo '<a class="dashboard-link" href="'.url('community/dashboard').'" >'.t('ADMIN DASHBOARD').'</a>';
                            ...
                            <div id="calender">
                                <a href="<?php echo url('calendar'); ?>"><img alt="Calendar" src="<?php echo base_path().drupal_get_path('theme','lifeecho'); ?>/images/calender.png" /></a>
                            </div>
                        </div>
                        <div class="imgtable">
                         <?php 
						 ...
						 if($_GET['a']!='1')
							print render($page['userprofilesidebar']);?>
                            </div>
                    </div><!-- imgdiv end -->
...
<?php
if(($user->uid == 0 && arg(0)== 'user') || (arg(0) == 'user' && arg(2) == 'edit') || (arg(0) == 'node' && arg(2) == 'edit') ) { ?>
        <div id="community_edit_outer"> <?php
     print render($page['content']); // display core blocks
?></div><?php
    }
    else {
        ?>
        <div class="Userdashboard" id="community_outer">
        <?php print render($page['content']); ?>
	<?php if (arg(0) == 'node' && is_numeric(arg(1)) ) { print render($page['community_request']); } ?>
        </div>
        <?php
    }
    ?>
<?php if(arg(2) <> 'edit') { ?>
<div class="imgdivCOMMUNITY2"><!-- Leftsidebar start -->
