...
?>
  ...
  <?php print $messages; ?>
  <?php endif; ?>
    <div class="Userdashboard"><?php print render($page['content']); // display core blocks ?>
<div id="relationship_action_btns">
     <?php $block = module_invoke('custom_block','block_view','user_relationship_block'); 
print $block['content'];
?>
</div>
</div>              
