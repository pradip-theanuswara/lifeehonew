       ...
       <div class="third">
           ...
           <div class="imgdiv">
                        <div class="user">
                            <div id="imgdiv1">
<?php
if(arg(0) == 'user' || arg(0) == 'users' || arg(0) == 'userlist') {
...
<ul>
<li><a href="#tabs-1" id="tabmatch-1"><?php print t('DISCIPLERS'); ?></a></li>
<li><a href="#tabs-2" id="tabmatch-2"><?php print t('DISCIPLES'); ?></a></li>
<li><a href="#tabs-3" id="tabmatch-3"><?php print t('ACCOUNTABILITY'); ?></a></li>
</ul>
<div id="tabs-1">
<?php 
...
<div id="tabs-2">
<?php 
$block = module_invoke('views', 'block_view', 'user_matches_disciplee-block_1');
print render($block['content']);
?>
</div>
<div id="tabs-3">
<?php 
$block = module_invoke('views', 'block_view', '6a3e3819015ee54e407ceda7bfcec9ea');
print render($block['content']);
?>
</div>
</div> <!-- End usermatch_container -->
<div id="matches_outside">
<h4><?php print t('MATCHES OUTSIDE OF YOUR COMMUNITY'); ?></h4>
