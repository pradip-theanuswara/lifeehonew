...
<script>
// script added for remove conflict in discipleship 101 tabs
...
<li class="menu-2770 menuparent  menu-path-front odd"><a title="Disciple"><?php print t('Disciple'); ?></a><ul><li class="menu-2780 menu-path-user  first   odd   last "><a href="<?php echo url('calendar'); ?>" title="Goes to main calendar"><?php print t('Goes to main calendar'); ?></a></li>
	...
	<?php } ?>	
       ...
       <div class="third">
           <?php
           global $user; ?>
           <div id="community_dasbboard" class="imgdiv">
                        <div class="user">
                            <div id="imgdiv1">
                                <?php
...
<li><a id="tabs-2-new" href="#tabs-2"><?php print t('ADMIN SHARED VIDEOS'); ?></a></li>
</ul>
<div id="tabs-1">
<?php
